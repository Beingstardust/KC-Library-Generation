...
SESSION_SCOPE = (
    ...
    "KCs and quarantined packets outside the ready session as explicit non-ready cases."
)
NON_GOAL = (
...
def _build_headline_findings(
    *,
    ...
    return [
        ...
        f"Kept {quarantine_count} quarantined KCs outside the ready review session without laundering them into reviewer-ready packets.",
        f"Preserved {excluded_count} unrecoverable held KCs as explicit exclusions outside the ready review session.",
...
def _build_workflow_markdown(
    *,
    ...
    lines = [
        ...
        f"- Quarantined non-ready cases carried as advisory only: `{quarantine_count}`",
        f"- Unrecoverable held exclusions carried as advisory only: `{excluded_count}`",
        "",
...
def build_restarted_human_review_capture(
    ...
    *,
    ...
    headline_findings = _build_headline_findings(
        ...
        quarantine_count=int(summary.get("quarantine_count") or 0),
