...
def _packet_lookup(source_review_packet_dir: Path) -> dict[str, dict[str, Any]]:
    packets = read_jsonl(source_review_packet_dir / "review_packet.jsonl")
...
def resolve_restarted_review_audits(
    *,
    ...
    packet_lookup = _packet_lookup(source_review_packet_dir)
