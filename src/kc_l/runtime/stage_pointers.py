...
def _looks_absolute(text: str) -> bool:
    # POSIX absolute (the real HPC target) or Windows drive-letter absolute (a dev checkout).
    # Path.is_absolute() alone is not enough: Windows treats a POSIX path like "/path/to/scratch/..."
