...
def build_stage_preflight(stage_key: str) -> dict[str, Any]:
    ...
    next_actions = {
        "intake": [
            ...
            "Run python scripts/local/run_corpus_intake.py locally or python3 scripts/local/run_corpus_intake.py on Sofja/Linux to ingest every PDF in data/input/course_materials.",
