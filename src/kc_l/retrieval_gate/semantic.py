...
in the retrieval_windowing copy (never in this one), its own docstring documents it as
archived for historical retrieval code, and it has no live caller. That exclusion applies
to build_name_seed_terms specifically, not to the rest of this module's surface.
