...
def build_name_seed_terms(
    ...
    *,
    ...
    # Step 6.6 to Step 6.8 runtime must stay on build_name_context_terms and
    # should not import this helper from the downstream retrieval gate package.
