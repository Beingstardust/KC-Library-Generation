...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Discover current Step 1, Step 1.5, Step 6.6, Step 6.7, and Step 6.75 artifacts and refresh the stable "
            "alias files used by the clean-start Step 5 and Step 6 templates."
        )
    )
    parser.add_argument(
        "--check",
