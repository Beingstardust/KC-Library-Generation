...
def main() -> int:
    ...
    with audit:
        ...
        audit.log_kv("document_level_status", result["summary"].get("document_level_status", "ok"))
        for warning in result["summary"].get("document_level_warnings", []):
            audit.log_kv("document_level_warning", warning)
