...
def main() -> int:
    ...
    review_packet_set_path = resolve_repo_path(
        ...
        or "data/processed/kc_review_packets_restarted/_sets/2026-03-23_003321_step6_8_kc_review_packets_restarted_set.json"
    )
    review_packet_set_obj = read_json(review_packet_set_path)
    source_step6_8_set_id = str(review_packet_set_obj.get("set_id") or review_packet_set_path.stem)
