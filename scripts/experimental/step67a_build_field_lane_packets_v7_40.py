...
OUT_ROOT = Path("data/processed/step67_sidecar_lane_packets_v7_40")
...
def main() -> None:
    ...
    for packet in packets:
        ...
        output_rows.append({
            "lane_packet_contract_version": "step67a_field_lane_packets_v7_40",
            "run_id": run_id,
    ...
    summary = {
        "stage": "step67a_build_field_lane_packets_v7_40",
        "run_id": run_id,
    ...
    md: list[str] = []
    md.append("# Step 6.7A v7 40-KC diagnostic field-lane packet audit")
    md.append("")
    md.append("## Summary")
    md.append("")
    md.append("```json")
    ...
    print("STEP67A_V7_40_LANE_RUN_ID =", run_id)
    print("STEP67A_V7_40_LANE_DIR =", out_dir.as_posix())
    print("STEP67A_V7_40_LANE_PACKETS =", lane_packets_path.as_posix())
    print("STEP67A_V7_40_LANE_SUMMARY =", summary_path.as_posix())
    print("STEP67A_V7_40_LANE_AUDIT_MD =", audit_path.as_posix())
    ...
    print("STEP67A_V7_40_FIELD_LANE_PACKETS_DONE")
