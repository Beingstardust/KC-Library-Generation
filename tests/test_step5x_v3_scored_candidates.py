...
def test_clean_cross_validation_definition_is_standalone_positive_definition():
    row = _score_rows(
        _stage1_candidate_row(
            ...
            topic_path_labels=["Evaluation", "Sampling"],
            parent_topic_label="Sampling",
            text="Cross-validation is a widely-used model evaluation method that aims to make effective use of all labeled instances in D for both training and testing.",
            alignment_breakdown={"canonical_name_token_hits": 2, "flags": {}, "competitor_token_hits": 2},
            support_profile={"contamination_exclusion_hint": True},
        )
    )[0]
