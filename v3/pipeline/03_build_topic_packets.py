...
def topic_support_state(evidence):
    """Report source availability without claiming that a finite packet is complete."""
    if evidence:
        return ("draftable", "child_source_evidence_available_no_completeness_claim")
    return ("insufficient_support", "no_child_source_evidence_available")
...
def main():
    ...
    for node in nodes:
        ...
        support_state, support_reason = topic_support_state(evidence)
        packets.append({
