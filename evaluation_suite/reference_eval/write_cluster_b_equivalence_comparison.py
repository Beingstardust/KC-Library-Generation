...
Emits cluster_b_equivalence_comparison.csv with one row per case whose primary verdict differs, and
...
OUT = BASE / "output" / "cluster_b_equivalence_comparison.csv"

RUNS = [
    ("ant2_tp4_frozen", BASE / "output" / "selene_penalty_free_raw.json"),
    ("cluster_b_cu124_a100", BASE / "output" / "selene_cluster_b_cu124_sentinel_raw.json"),
]
